...
function sb_tbfa_activation() {
    if(!sb_tbfa_check_core()) {
        wp_die(sprintf(__('You must install plugin %1$s first! Click here to %2$s.', 'sb-tbfa'), '<a href="https://wordpress.org/plugins/sb-core/">SB Core</a>', sprintf('<a href="%1$s">%2$s</a>', admin_url('plugins.php'), __('go back', 'sb-tbfa'))));
    }
